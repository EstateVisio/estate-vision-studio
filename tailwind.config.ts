  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        estateTeal: "hsl(var(--estate-teal))",
        skyGlow: "hsl(var(--sky-glow))",
        freshGreen: "hsl(var(--fresh-green))",
        gradeA: "hsl(var(--grade-a))",
        gradeB: "hsl(var(--grade-b))",
        gradeC: "hsl(var(--grade-c))",
        gradeD: "hsl(var(--grade-d))",
        gradeE: "hsl(var(--grade-e))",
        gradeF: "hsl(var(--grade-f))",
